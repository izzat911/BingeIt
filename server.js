...
// Static assets (css, js, images) are always public - login/signup pages need them too
...
app.listen(PORT, () => {
    console.log(`BingeIt server running at http://localhost:${PORT}`);
});